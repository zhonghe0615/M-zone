...
<ul>
		...
		<div id="templatemo_main">
			<div class="content_wrapper content_mb_60">
				...
				<form action="./Service/crecommend_cfg.php" method="post">
				<div class="col_2">
					<h2>Recommend List</h2>
					<p>Recommend Name: <input type="text" name="rname"></input></p>
					<p>Type: <input type="text" name="type"></input></p>
				...
				<?php 
				$stmt = $dbh->prepare("SELECT * FROM recommend,follow,user where follow.username= ? and follow.fousername = recommend.username and user.username = follow.fousername limit 0,3");
				$stmt->bindParam(1, $_SESSION["username"]);
				$stmt->execute();
				while($row = $stmt->fetch()){
				?>
				Friend Name:<?=$row[name] ?></br>
				Recommend List Name:<a 
				onClick="window.open('recommend2.php?rid=<?=$row[rid] ?>&rname=<?=$row[rname] ?>','','height=550,width=620,scrollbars=yes,status =yes')"
				><?=$row[rname] ?></a></br>
				Recommend Time: <?=$row[rtime] ?>
				</br></br></br>
				<?php 
				}
				?>
			...
			<div class="content_wrapper">
				...
				<div class="col_3">
					...
					<a href="" class="more"
						onClick="window.open('editrecommend.php?rid=<?=$row[rid] ?>&rname=<?=$row[rname] ?>','','height=550,width=620,scrollbars=yes,status =yes')">Edit</a>
					<a href="recommend.php?delete=<?=$row[rid] ?>" class="more">Delete</a>	
