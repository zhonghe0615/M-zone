...
if ($_GET["delete"] != null){
	$stmt = $dbh->prepare("Delete FROM concert where concertID = ?");
...
<ul>
		...
		<div id="templatemo_main">
			<div class="content_wrapper content_mb_60">
				...
				<form action="./Service/postconcert_cfg.php" method="post">
				<div class="col_2">
					<h2>Post Concert</h2>
					<table>
					<tr>
					<td>Concert Name:</td>
					<td><input type="text" name="concertname" id="concertname"></input> &nbsp;&nbsp;</td>
					</tr>
					<tr>
					<td>Concert Info:</td>
					<td><input type="text" name="info" id="info" style="width: 250px;"></input></td>
					</tr>					
					<tr>
<!-- 					<td>Concert Time:</td> -->
<!-- 					<td><input type="text" name="concerttime" id="concerttime"></input></td> -->
<!-- 					</tr>					 -->
<!-- 					<tr> -->
<!-- 					<td>Location:</td> -->
...
<!-- 					</tr>	 -->
<!-- 					<td>Availability:</td> -->
<!-- 					<td><input type="text" name="availability" id="availability"></input></td> -->
<!-- 					</tr>		 -->
<!-- 					<td>Ticket Link:</td> -->
<!-- 					<td><input type="text" name="ticketlink" id="ticketlink"></input></td> -->
<!-- 					</tr>					 -->
					</table>

					<input name="submit" type="image" src="./images/create.jpg" align="absmiddle" style="margin-top:8px;" 
					onclick="javascript:document.this.form.submit();"/>
					<a href="javascript:history.go(-1);" class="more">Back</a>
				</div>
				</form>
			...
			<div class="content_wrapper">
				...
				<?php 
				$stmt = $dbh->prepare("SELECT * FROM concert where username = ?");
				...
				<div class="col_3">
					...
					<a href="" class="more"
						onClick="window.open('editconcert.php?concertID=<?=$row[concertID] ?>','','height=550,width=620,scrollbars=yes,status =yes')">Edit</a>
					<a href="" class="more"
						onClick="window.open('editconcerta.php?concertID=<?=$row[concertID] ?>','','height=550,width=620,scrollbars=yes,status =yes')">Artist</a>
					</br>
										<a href="" class="more"
						onClick="window.open('editctype.php?concertID=<?=$row[concertID] ?>','','height=550,width=620,scrollbars=yes,status =yes')">Type</a>
					<a href="postconcert.php?delete=<?=$row[concertID] ?>" class="more">Delete</a>	
