    ...
    <div id="templatemo_main">
		<div class="content_wrapper content_mb_60">
            <div class="col_2">
                ...
                <a href="" class="more" onClick="window.open('edituser.php','','height=550,width=620,scrollbars=yes,status =yes')">Edit</a>
            </div>        
            <div class="col_2 no_margin_right">
				...
				<?php
		 		...
		 		?>
		 		<form name="form1" action="" method="post" onsubmit="return CheckPost()" enctype="multipart/form-data">
        ...
        <div class="content_wrapper content_mb_60">
            <div class="col_4">
                ...
                <a href="" class="more" onClick="window.open('edittaste.php','','height=550,width=620,scrollbars=yes,status =yes')">More</a>
            </div>  
            ...
            <div class="col_34 no_margin_right">
                ...
                if ($score>4){
                ?>
                <p>You have the right to post new concert!</p>
                <a href="postconcert.php" class="more">Start</a>
                <?php 
                }else{
                ?>
                <p>You don't have the right to post new concert!</p>
                <?php 
        ...
        <div class="content_wrapper">
            <div class="col_3">
                ...
                ?>
 				...
 				<a href="" class="more" onClick="window.open('editfan.php','','height=550,width=620,scrollbars=yes,status =yes')">More</a>
            </div>
            ...
            <div class="col_3">
                ...
                ?>
                 ...
                 <a href="" class="more" onClick="window.open('editfollow.php','','height=550,width=620,scrollbars=yes,status =yes')">More</a>
            </div>
